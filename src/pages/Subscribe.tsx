                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 4 }}>
                      ...
                      {plan.id === 'pro' && <span style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)' }}>$ / {plan.period}</span>}
                      {plan.id === 'free' && <span style={{ fontSize: 14, color: '#8e91a0' }}>$</span>}
                    </div>
          ...
          <div style={{ maxWidth: 520, margin: '0 auto' }}>
            ...
            <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #e0e2e8', padding: '16px 20px', marginBottom: 24 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10, fontSize: 14 }}>
                ...
                <span style={{ fontWeight: 600, color: '#1c1c1e' }}>٩٩ $</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10, fontSize: 14 }}>
                <span style={{ color: '#555a6a' }}>خصم الإطلاق (٥٠٪)</span>
                <span style={{ fontWeight: 600, color: '#00b473' }}>−٤٩.٥ $</span>
              </div>
              <div style={{ borderTop: '1px solid #e0e2e8', paddingTop: 12, display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 16, fontWeight: 700 }}>
                ...
                <span style={{ color: '#1c1c1e' }}>٤٩.٥ $</span>
              </div>
              <p style={{ fontSize: 12, color: '#8e91a0', marginTop: 8 }}>ثم ٩٩ $ شهرياً · إلغاء في أي وقت</p>
            ...
            <button onClick={handlePay} disabled={loading} style={{
              ...
              {loading
                ...
                : <><Lock size={15} variant="Outline" /> ادفع ٤٩.٥ $ الآن</>
              }
            </button>
