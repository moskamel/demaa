...
const DEMO_COMMANDS = [
  {
    ...
    stats: [{ n: '35', l: 'معلق', c: '#ff7a3d' }, { n: '14,500', l: 'ج.م', c: T.ink }, { n: '8', l: 'كاش ⚠️', c: '#ff5577' }],
...
export default function Landing() {
  ...
  const [demoMessages, setDemoMessages] = useState<Array<{ role: 'user' | 'ai'; text: string; stats?: typeof DEMO_COMMANDS[0]['stats']; actions?: string[] }>>([
    { role: 'ai', text: 'صباح الخير! 🌅 أنا ديما، مساعدك الذكي. كيف أساعدك اليوم؟', stats: [{ n: '47', l: 'طلب جديد', c: '#ff7a3d' }, { n: '14k', l: 'ج.م اليوم', c: T.ink }, { n: '3', l: 'مشاكل', c: '#ff5577' }] },
  ])
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
          ...
          <div className="animate-fade-in-up" style={{ background: T.surface, borderRadius: 24, border: `1px solid ${T.hairline}`, overflow: 'hidden', boxShadow: '0 24px 64px rgba(0,0,0,0.6)', animationDelay: '120ms' }}>
            ...
            <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: 12, height: 320, overflowY: 'auto' }}>
              {[
                { text: 'صباح الخير! ٤٧ طلب جديد، ١٤k ج.م 🌅', isAi: true },
