      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {!activeConv ? (
          ...
          <>
            ...
            {/* input area */}
            <div style={{ margin: '0 30px 30px', borderRadius: 20, background: 'var(--canvas-soft)', padding: '12px 20px 14px', flexShrink: 0, boxShadow: '0 -4px 24px rgba(0,0,0,0.12), 0 4px 24px rgba(0,0,0,0.18)' }}>
