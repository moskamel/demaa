...
export default function Billing() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '30px 30px 30px 20px', display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          ...
          {/* hero banner */}
          <div className="animate-fade-in-up" style={{ background: 'linear-gradient(135deg, #007cf0 0%, #00dfd8 100%)', borderRadius: 20, padding: '32px 28px', textAlign: 'center', animationDelay: '80ms' }}>
          ...
          {/* plan features card */}
          <div className="animate-fade-in-up" style={{ background: 'var(--canvas-soft)', borderRadius: 20, border: '2px solid #6a4cf5', padding: '28px', position: 'relative', overflow: 'hidden', animationDelay: '120ms' }}>
