...
async function seedDemoData(orgId: string, storeId: string) {
  ...
  const memoryItems = [
    ...
    { key: 'avg_order_value', value: '487', confidence: 0.99, label: 'متوسط قيمة الطلب ($)' },
  ...
  await prisma.notification.createMany({
    data: [
      ...
      { organizationId: orgId, type: 'RISK_ALERT', priority: 'important', title: 'طلب مشبوه #10233', body: 'كاش عند الاستلام · عميلة جديدة · قيمة 750 $' },
    ],
  })
